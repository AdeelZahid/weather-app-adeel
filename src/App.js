...
componentDidMount() {
  ...
  if(navigator.geolocation){
    navigator.geolocation.getCurrentPosition( (position) => {
      ...
      Axios.get(`http://api.weatherstack.com/current?access_key=55b1ea0965849941a2b1fa55a72f9698&query=
      ${this.state.coords.latitude},${this.state.coords.longitude}`).then((res, rej) => {
        let useWeather = {
